...
public abstract class ListTest {
    ...
    /**
     * Test retreat with multiple elements in the left mathematical list and a
     * non empty right list.
     */
    @Test
    ...
    /**
     * Test retreat with multiple elements in the left mathematical list and an
     * empty right list.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "yellow", "orange", "green",
                "purple");
        List<String> list2 = this.createFromArgsRef(3, "yellow", "orange", "green",
                "purple");
        /*
    ...
    /**
     * Test retreat with one element in the left mathematical list and an empty
     * right list.
     */
    @Test
    ...
    /**
     * Test retreat with one element in the left mathematical list and a non
     * empty right list.
     */
    @Test
